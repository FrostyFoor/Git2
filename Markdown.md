...
1. Заводим аккаунт в GitHab
2. Дружим аккаут GitHab и VisualCode
3. Можем работать удаленно с нашим файлом

__при создании ветки в GitHab и сливании с VisualCode он не саздает ветки, а создает новые файлы.__